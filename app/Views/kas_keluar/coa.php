    ...
    <div className="overflow-x-auto">
      <table className="w-full text-sm">
        ...
        <tbody className="divide-y divide-slate-100">
          {data.map((row, i) => (
            <tr key={row.id} className={`hover:bg-slate-50 transition-colors ${row.is_off == 1 ? 'opacity-60' : ''}`}>
              ...
              <td className="px-5 py-3.5"><TipeBadge tipe={row.tipe}/></td>
              ...
              <td className="px-5 py-3.5"><StatusBadge isOff={row.is_off}/></td>
              <td className="px-5 py-3.5">
