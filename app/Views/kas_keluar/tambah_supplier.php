...
<head>
  ...
  <title>Tambah Supplier — FinanceOS</title>
        ...
        <header className={`fixed top-0 right-0 z-20 flex items-center justify-between h-16 bg-white border-b border-slate-200 px-4 shadow-sm sidebar-transition ${collapsed ? 'left-16' : 'left-64'}`}>
          <div className="flex items-center gap-3">
            ...
            <div className="hidden sm:flex items-center gap-1.5 text-sm">
              ...
              <Icon name="ChevronRight" size={13} className="text-slate-400"/>
              <span className="font-semibold text-slate-800">Tambah Supplier</span>
            </div>
          </div>
        </header>
        ...
        <main className="pt-16 min-h-screen">
          <div className="p-6 max-w-3xl mx-auto space-y-6 fade-in">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-slate-800">Tambah Supplier Baru</h1>
                <p className="text-sm text-slate-500">Daftarkan vendor atau penyedia barang/jasa perusahaan</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
              <form action="/kas_keluar/simpan_supplier" method="POST">
                ...
                <div className="px-6 py-4 bg-slate-50 border-t border-slate-100 flex items-center justify-end gap-3">
                  <a href="/kas_keluar/supplier" className="px-5 py-2.5 text-sm font-medium text-slate-700 hover:bg-slate-200 bg-slate-100 rounded-xl transition-colors">
                    Batal
                  </a>
                  <button
                    type="submit"
                  ...
                  >
                    <Icon name="Save" size={16}/> Simpan Supplier
                  </button>
                </div>
              </form>
            </div>
...
ReactDOM.createRoot(document.getElementById('root')).render(<TambahSupplierPage />);
</script>
</body>
</html>
