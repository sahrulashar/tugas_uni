        ...
        <main className="pt-16 min-h-screen">
          <div className="p-6 max-w-3xl mx-auto space-y-6 fade-in">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-slate-800">Tambah Akun COA Baru</h1>
                <p className="text-sm text-slate-500">Daftarkan kode dan klasifikasi akun baru ke dalam sistem keuangan</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
              <form action="/kas_keluar/simpan_coa" method="POST">
                ...
                <div className="px-6 py-4 bg-slate-50 border-t border-slate-100 flex items-center justify-end gap-3">
                  ...
                  >
                    <Icon name="Save" size={16}/> Simpan Akun
                  </button>
                </div>
              </form>
            </div>
...
ReactDOM.createRoot(document.getElementById('root')).render(<TambahCoaPage />);
</script>
</body>
</html>
