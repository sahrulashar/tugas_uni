...
<head>
  ...
  <title>Edit Supplier — FinanceOS</title>
        ...
        <main className="pt-16 min-h-screen">
          <div className="p-6 max-w-3xl mx-auto space-y-6 fade-in">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-slate-800">Edit Data Supplier</h1>
                <p className="text-sm text-slate-500">Perbarui informasi vendor atau rekanan bisnis</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
              <form action="/kas_keluar/update_supplier" method="POST">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div>
                      ...
                      <input
                        ...
                        name="kode_supplier"
                        required
                        defaultValue={data.kode_supplier}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        name="nama_supplier"
                        required
                        defaultValue={data.nama_supplier}
                ...
                <div className="px-6 py-4 bg-slate-50 border-t border-slate-100 flex items-center justify-between">
                  <div>
                    {data.status === 'Aktif' ? (
                      ...
                      >
                        <Icon name="PowerOff" size={15}/> Nonaktifkan Supplier
                      </a>
                    ) : (
                      <a
...
ReactDOM.createRoot(document.getElementById('root')).render(<EditSupplierPage />);
</script>
</body>
</html>
