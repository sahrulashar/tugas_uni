...
<head>
  ...
  <title>Edit COA � FinanceOS</title>
        ...
        <main className="pt-16 min-h-screen">
          <div className="p-6 max-w-3xl mx-auto space-y-6 fade-in">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-slate-800">Edit Akun COA</h1>
                <p className="text-sm text-slate-500">Perbarui informasi kode atau klasifikasi akun keuangan</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
              <form action="/46124026/kas_keluar/update_coa_l1H" method="POST">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div>
                      <label className="block text-sm font-medium text-slate-700 mb-1.5">
                        Kode Akun / COA <span className="text-red-500">*</span>
                      </label>
                      <input
                        type="text"
                        name="kode_coa"
                        required
                        defaultValue={coa.kode_coa}
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
                    ...
                    <div>
                      ...
                      <select
                        name="saldo_normal"
                        value={saldoNormal}
                        onChange={(e) => setSaldoNormal(e.target.value)}
                        className="w-full px-4 py-2.5 text-sm border border-slate-300 rounded-xl focus:ring-2 focus:ring-brand-500 focus:border-brand-500 outline-none bg-white cursor-pointer"
                      >
                ...
                <div className="px-6 py-4 bg-slate-50 border-t border-slate-100 flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    {isAktif ? (
                      <a
                        href={`/46124026/kas_keluar/hapus_coa_l1H/${coa.id}`}
                      ...
                      <a
                        href={`/46124026/kas_keluar/aktifkan_coa_l1H/${coa.id}`}
                    ...
                    <a
                      href={`/46124026/kas_keluar/hapus_permanen_coa_l1H/${coa.id}`}
...
ReactDOM.createRoot(document.getElementById('root')).render(<EditCoaPage />);
</script>
</body>
</html>
