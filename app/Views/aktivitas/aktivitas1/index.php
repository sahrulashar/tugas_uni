    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md fade-in">
        ...
        <div className="flex gap-3 px-6 pb-6">
          ...
          <a href={`/46124026/aktivitas/aktivitas1/hapus/${item.id}`}
                      ...
                      <tr key={row.id} className="hover:bg-slate-50 transition-colors">
                        ...
                        <td className="px-5 py-3.5">
                          <div className="flex items-center justify-center gap-1">
                            <a href={`/46124026/aktivitas/aktivitas1/lihat/${row.id}`} title="Detail"
                              className="p-1.5 rounded-lg text-slate-400 hover:text-blue-600 hover:bg-blue-50 transition-colors">
                              <Icon name="Eye" size={15}/>
                            </a>
                            <a href={`/46124026/aktivitas/aktivitas1/edit/${row.id}`} title="Edit"
