    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md fade-in">
        ...
        <div className="flex gap-3 px-6 pb-6">
          ...
          <a href={`/46124026/aktivitas/aktivitas1/hapus_l1H/${item.id}`}
...
function RencanaBeli() {
  ...
  const currentPath = '/46124026/aktivitas/aktivitas1';
      ...
      <div className={`sidebar-transition ${collapsed ? 'ml-16' : 'ml-64'}`}>
        ...
        <header className={`fixed top-0 right-0 z-20 flex items-center justify-between h-16 bg-white border-b border-slate-200 px-4 shadow-sm sidebar-transition ${collapsed ? 'left-16' : 'left-64'}`}>
          ...
          <div className="flex items-center gap-2">
            ...
            <a href="/46124026/aktivitas/aktivitas1/tambah_l1H"
                    ...
                    {filtered.length === 0 ? (
                      <tr>
                        <td colSpan="6" className="py-14 text-center text-slate-500">
                          ...
                          <a href="/46124026/aktivitas/aktivitas1/tambah_l1H" className="mt-3 inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-brand-600 hover:bg-brand-700 rounded-lg transition-colors">
                      ...
                      <tr key={row.id} className="hover:bg-slate-50 transition-colors">
                        ...
                        <td className="px-5 py-3.5">
                          <div className="flex items-center justify-center gap-1">
                            <a href={`/46124026/aktivitas/aktivitas1/lihat_l1H/${row.id}`} title="Detail"
                              className="p-1.5 rounded-lg text-slate-400 hover:text-blue-600 hover:bg-blue-50 transition-colors">
                              <Icon name="Eye" size={15}/>
                            </a>
                            <a href={`/46124026/aktivitas/aktivitas1/edit_l1H/${row.id}`} title="Edit"
