      ...
      <div className={`sidebar-transition ${collapsed ? 'ml-16' : 'ml-64'}`}>
        ...
        <header className={`fixed top-0 right-0 z-20 flex items-center justify-between h-16 bg-white border-b border-slate-200 px-4 shadow-sm sidebar-transition ${collapsed ? 'left-16' : 'left-64'}`}>
          ...
          <div className="flex items-center gap-2">
            ...
            <a href="/46124026/aktivitas/aktivitas2/tambah"
                    ...
                    {filtered.length === 0 ? (
                      <tr>
                        <td colSpan="5" className="py-14 text-center text-slate-500">
                          ...
                          <a href="/46124026/aktivitas/aktivitas2/tambah" className="mt-3 inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-brand-600 hover:bg-brand-700 rounded-lg transition-colors">
